...
class ModelLoader:
    ...
    def evaluate(self):
        ...
        print('\n')
        test_loss, categorical_accuracy, test_precision, test_recall, test_f1_score, test_auc = self.loaded_model.evaluate(self.test_ds, verbose=2)
        ...
        print('\nTest loaded f1_score is: %s' % (test_f1_score))
